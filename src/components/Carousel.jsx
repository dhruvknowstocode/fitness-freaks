...
const CarouselComponent = () => (
  <section id="carousel" className="py-20 bg-gray-100 border-t border-b border-black">
    <div className="container mx-auto px-4">
      ...
      >
        {testimonials.map((testimonial, index) => (
          <div key={index} className="text-center p-8 bg-white rounded-lg shadow-md mx-4 sm:mx-6">
